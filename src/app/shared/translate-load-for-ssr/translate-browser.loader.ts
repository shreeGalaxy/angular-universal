...
export class TranslateBrowserLoader implements TranslateLoader {
    ...
    public getTranslation(lang: string): Observable<number | object> {
...
export function translateBrowserLoaderFactory(httpClient: HttpClient, transferState: TransferState): object {
